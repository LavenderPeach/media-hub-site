...
class Television(models.Model):
    ...
    author = models.CharField(max_length=100)  # The director of the movie
    ...
    cover_image_url = models.URLField()  # URL to the movie's poster image
    amazon_url = models.URLField()  # URL to the movie's trailer
